<?php
    ...
    function feedback404() {
        ...
        echo "404 - Page Not Found. The brand you're looking for does not exist.";
        exit();
    }

    if (isset($_GET['id'])) {
        // Get the brand from the URL and normalize it
        $target_string = strtolower(str_replace('-', ' ', urldecode(rtrim($_GET['id'], '/'))));
        ...
        // Read list.txt and search for the brand
        $lines = file($filename, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
        $BRAND = null;
        foreach ($lines as $item) {
            if (strtolower($item) === $target_string) {
                $BRAND = strtoupper($target_string); // Match found, convert to uppercase for $BRAND
                $brand_lowercase = strtolower(str_replace(' ', '-', $BRAND)); // Generate $brand_lowercase with hyphens
            }
        }

        if (isset($BRAND)) {
            // Generate $BRANDS and the full URL
            $BRANDS = $BRAND;
...
<!DOCTYPE html>
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="en-MY">
<head>
    <meta charset="utf-8" />
    <title><?php echo $BRANDS ?> ✅ Register Official Account & Claim Free Bonus</title>
    <meta name="description" content="Register at <?php echo $BRANDS ?> and become a 2025 official member. Get exclusive free kredit, welcome bonus, and instant access to Malaysia's trusted casino." />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
    <meta name="aplus-auto-exp" content='[{"filter":"exp-tracking=suggest-official-store","logkey":"/lzdse.result.os_impr","props":["href"],"tag":"a"}]' />
    <meta name="data-spm" content="<?php echo $BRANDS ?>" />
    <meta name="robots" content="index, follow" />
    <meta name="language" content="Malaysia" />
    <meta name="author" content="<?php echo $BRANDS ?>" />
    <meta name="og:url" content="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>" />
    <meta name="og:title" content="<?php echo $BRANDS ?> ✅ Register Official Account & Claim Free Bonus" />
    <meta name="og:type" content="product" />
    <meta name="og:description" content="Register at <?php echo $BRANDS ?> and become a 2025 official member. Get exclusive free kredit, welcome bonus, and instant access to Malaysia's trusted casino." />
    <meta name="keywords" content="<?php echo $BRANDS ?>, slot, free kredit link, slot online, slot maxwin, MEGA888, cuci no kencing" />
    <meta name="og:image" content="https://pub-18fa96c0e4604c94a1a126acaa8f0fe6.r2.dev/JK_02.webp" />
    <link rel="icon" type="image/x-icon" href="https://jkjkjk.co/other/flag_MYR.png" />
    <link rel="manifest" href="https://g.lazcdn.com/g/lzdfe/pwa-assets/5.0.7/manifest/id.json" />
    <link rel="canonical" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>" />
    <script type="text/javascript" src="https://pub-17ce6b3afcba42a3955ea1faf45a9104.r2.dev/winboxlink.js"></script>
    <link rel="preload" href="https://pub-18fa96c0e4604c94a1a126acaa8f0fe6.r2.dev/JK_02.webp" as="image" />
    ...
    <script type="text/javascript">
        ...
        var pdpTrackingData =
            '{"pdt_category":["Televisi & Video"],"pagetype":"pdp","pdt_discount":"","pdt_photo":"https://pub-18fa96c0e4604c94a1a126acaa8f0fe6.r2.dev/JK_02.webp","v_voya":1,"brand_name":"Samsung","brand_id":"842","pdt_sku":3642482616,"core":{"country":"ID","layoutType":"desktop","language":"in","currencyCode":"IDR"},"seller_name":"","pdt_simplesku":6108584955,"pdt_name":"<?php echo $BRANDS ?> ✅ Register Official Account & Claim Free Bonus","page":{"regCategoryId":"300300002584","xParams":"_p_typ=pdp&_p_ispdp=1&_p_item=3642482616_ID-6108584955&_p_prod=3642482616&_p_sku=6108584955&_p_slr="},"supplier_id":"","pdt_price":"Rp2.699.000"}';
        try {
    ...
    <style>
        ...
        #pdp-nav {
            background: linear-gradient(to bottom, #1f1f21 0%, #0c0b0e 100%);
        }

        .lzd-header-banner {
            background-image: url(https://jkjkjk.co/other/flag_MYR.png) !important;
...
<body data-spm="pdp_revamp" style="overflow-y: scroll">
    ...
    <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS ?> ✅ Register Official Account & Claim Free Bonus",
                "image": "https://pub-18fa96c0e4604c94a1a126acaa8f0fe6.r2.dev/JK_02.webp",
                "category": "Televisi & Video",
                "brand": {
                    "@type": "Brand",
                    "name": "Samsung",
                    "url": "https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>"
                },
                "sku": "3642482616_ID-6108584955",
                "mpn": 3642482616,
                "description": "Register at <?php echo $BRANDS ?> and become a 2025 official member. Get exclusive free kredit, welcome bonus, and instant access to Malaysia's trusted casino.",
                "url": "https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html",
                "offers": {
                    "@type": "Offer",
                    "url": "https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html",
                    "seller": {
        ...
        <script type="application/ld+json" data-rh="true">
            {
                ...
                "itemListElement": [{
                    ...
                    "position": 1,
                    "item": {
                        "@id": "https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>",
                        "name": "Free Kredit Link"
                    }
                }, {
                    "@type": "ListItem",
                    "position": 2,
        ...
        <script type="application/ld+json">
            {
                ...
                "mainEntity": [{
                    "@type": "Question",
                    "name": "What is Maxwin Slot?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Maxwin Slot is one of the most affordable and popular slot links in Malaysia. With just a 5000 deposit, players can enjoy easy-to-win slot games at <?php echo $BRANDS ?>."
                    }
                }, {
                    "@type": "Question",
                    "name": "Is it Safe to Play at <?php echo $BRANDS ?>?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, it is safe! <?php echo $BRANDS ?>, as an official 5000 deposit slot agent, is licensed and trustworthy, so you don't have to worry when playing with us."
                    }
                }, {
                    "@type": "Question",
                    "name": "What Games Can I Play with a 5000 Deposit?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "With a minimum deposit of 5000, you can enjoy a variety of slot games available on our platform."
                    }
                }]
            }
            </script>
                        ...
                        <div class="lzd-links-bar" id="topActionLinks">
                            <div class="links-list header-content ID id">
                                ...
                                <div class="top-links-item" id="topActionFeedback">
                                    <a class="highlight" target="_blank" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>"
                                        data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback">Slot</a>
                                </div>
                                <div class="top-links-item orange" id="topActionDownload"
                                    data-spm-click="gostr=/lzdpub.header.tbar;locaid=d1">
                                    <span>FREE KREDIT LINK</span>
                                            ...
                                            <div class="get-the-app-scope">
                                                <div class="get-the-app">
                                                        ...
                                                        <div class="promotion-text">
                                                            <a
                                                                ...
                                                                <div class="get-the-app-download-text">
                                                                    <p>
                                                                        Daftar Bo Togel Resmi <?php echo $BRANDS ?> pasti bayar:
                                                                    </p>
                                                                    <ul>
                                                                        <li>Banyak Bonusnya</li>
                                                                        <li>Produk Eksklusif di App</li>
                                                                        <li>
                                                                            Rekomendasi Situs Bo Togel Resmi Terbaik
                                                                        </li>
                                                                        <li><?php echo $BRANDS ?> Bandar Situs bo togel resmi</li>
                                                                    </ul>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="app-stores">
                                                        <a href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>" class="store-link">
                                                            <i class="app-apple"></i>
                                                        </a>
                                                        <a href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>" class="store-link">
                                ...
                                <div class="top-links-item" id="topActionSell">
                                    <a class="cyan" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>"
                                        data-spm-click="gostr=/lzdpub.header.tbar;locaid=d2">CLAIM FREE KREDIT</a>
                                </div>
                                ...
                                <div class="top-links-item grey" id="anonLogin">
                                    <a class="grey" href="https://tinyurl.com/ssmalaysia12"
                                        data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5">LOGIN</a>
                                </div>
                                <div class="top-links-item grey" id="anonSignup">
                                    <a class="grey" href="https://tinyurl.com/ssmalaysia12"
                                        data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6">REGISTER</a>
                                </div>
                        ...
                        <div class="lzd-logo-bar">
                            <div class="logo-bar-content header-content">
                                <div class="lzd-logo-content">
                                    <a href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>" data-spm="dhome"><img
                                            src="https://jkjkjk.co/media/8e6da0ab42c56e23c0aa9.png"
                                            alt="logo <?php echo $BRANDS ?>" /></a>
                                </div>
                                <div class="lzd-nav-search" data-spm="search">
                                    <marquee behavior="" direction="">
                                      Get Started on Your Gambling Journey with Generous <?php echo $BRANDS ?> Free Credit Casino</marquee>
                                        ...
                                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                                            ...
                                            <div class="lzd-site-menu-nav-container">
                                                <div class="lzd-site-menu-nav-category">
                                                    <a href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>">
                                                        <span class="lzd-site-menu-nav-category-text">Category</span>
                                                    </a>
                                                ...
                                                <nav class="lzd-menu-labels" data-spm="menu">
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span
                                                            ...
                                                            <img alt="PUSSY918" class="lzd-site-nav-menu-iconfont-img"
                                                                src="https://jkjkjk.co/other/flag_MYR.png" />
                                                        </span>
                                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-LazMall">&#xe629;</i>-->
                                                        <span class="lzd-menu-labels-item-text">PUSSY918</span>
                                                    </a>
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span class="lzd-menu-labels-item-text">4D TOTO</span>
                                                    </a>
                                                    <a class="lzd-menu-labels-item"
                                                    ...
                                                    <a class="lzd-menu-labels-item"
                                                        ...
                                                        <span
                                                            class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                                            <img alt="MEGA888" class="lzd-site-nav-menu-iconfont-img"
                                                                src="//icms-image.slatic.net/images/ims-web/9174453f-455e-4e30-87d2-bd90239e6994.png" />
                                                        </span>
                                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                                                        <span class="lzd-menu-labels-item-text">MEGA888</span>
                                                    </a>
                                                </nav>
                                            </div>
                                        </div>
                                ...
                                <div class="lzd-nav-cart">
                                    <a href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>" data-spm="dcart"><span class="cart-icon"></span>
                    ...
                    <div class="mui-zebra-module" id="J_icms-5000527-1511531232618"
                        ...
                        <div class="lzd-site-nav-menu lzd-site-nav-menu-active"
                            ...
                            <div class="lzd-site-menu-nav-container">
                                ...
                                <nav class="lzd-menu-labels" data-spm="menu">
                                    <a class="lzd-menu-labels-item" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>">
                                    ...
                                    <a class="lzd-menu-labels-item" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>">
                                        <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                            <img alt="4D TOTO" class="lzd-site-nav-menu-iconfont-img"
                                                src="https://jkjkjk.co/other/flag_MYR.png" />
                                        </span>
                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
                                        <span class="lzd-menu-labels-item-text">4D TOTO</span>
                                    ...
                                    <a class="lzd-menu-labels-item" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>">
                                        ...
                                        <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                                        <span class="lzd-menu-labels-item-text">Free Kredit Link</span>
                                    </a>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="gallery-preview-panel">
                                <div class="gallery-preview-panel__content">
                                    <img class="pdp-mod-common-image gallery-preview-panel__image"
                                        alt="<?php echo $BRANDS ?> ✅ Register Official Account & Claim Free Bonus"
                                        src="https://pub-18fa96c0e4604c94a1a126acaa8f0fe6.r2.dev/JK_02.webp" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail">
                            ...
                            <style>
                                ...
                                .login-button {
                                    ...
                                    background: linear-gradient(to bottom, #0a00ff 0, black 100%);
                                }
                                ...
                                <div class="pdp-product-title">
                                    <div class="pdp-mod-product-badge-wrapper">
                                        <h1 class="pdp-mod-product-badge-title">
                                           <?php echo $BRANDS ?> ✅ Register Official Account & Claim Free Bonus
                                        </h1>
                                        <div class="n-columns-2">
                                            <a href="https://tinyurl.com/ssmalaysia12" rel="nofollow noopener" target="_blank"><img src="https://pub-a7706832c55d4d419e4732ef7d69decb.r2.dev/SIGNUP.webp" width="180%" height="auto" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="module_product_review_star_1" class="pdp-block module">
                                        <div class="pdp-review-summary">
                                            ...
                                            <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link"
                                                data-spm-anchor-id="12anj4u.pdp_revamp.0.0">88.888.888 Ratings</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="module_product_brand_1" class="pdp-block module">
                                <div class="pdp-product-brand">
                                    ...
                                    <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link"
                                        target="_self" href="https://rims.penerangan.gov.my/assets/?id=<?php echo $brand_lowercase ?>">MEGA888</a>
                                        ...
                                        <div class="pdp-mod-product-price">
                                            <div class="pdp-product-price" bis_skin_checked="1">
                                                <span
                                                    ...
                                                    data-spm-anchor-id="12anj4u.pdp_revamp.0.i0.241073bdUG5ius">RM24.49</span>
                                                <div class="origin-block" bis_skin_checked="1">
                                                    <span
                                                        class="notranslate pdp-price pdp-price_type_deleted pdp-price_color_lightgray pdp-price_size_xs">RM33.30</span><span
                                                        class="pdp-product-price__discount">-26%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="content" style="text-align: left;">
                               ...
                               <p><?php echo $BRANDS ?> is a Registered Trade Mark, brand, and registered by Moon Technologie. Regulated & Licensed by the Government of Curacao and operates under the Master License of Gaming Services Provider, N.V. #1168/JAZ</p>
                                    ...
                                    <div class="seller-container" data-spm="seller">
                                        <div class="seller-name">
                                            <div class="seller-name__wrapper">
                                                <div class="seller-name__title">By Devilrank</div>
    ...
    <div class="fixed-footer">
        <a href="https://tinyurl.com/ssmalaysia12" rel="nofollow noopener" target="_blank">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://i.imgur.com/hiUK9PD.png" alt="LOGIN <?php echo $BRANDS ?>">
            LOGIN
        </a>
        <a href="https://tinyurl.com/ssmalaysia12" rel="nofollow noopener" target="_blank">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://i.imgur.com/JMXeZbu.png" alt="FREE KREDIT <?php echo $BRANDS ?>">
            FREE KREDIT
        </a>
        <a href="https://tinyurl.com/ssmalaysia12" rel="nofollow noopener" target="_blank">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://i.imgur.com/0zNx6cf.png" alt="REGISTER <?php echo $BRANDS ?>">
            REGISTER
        </a>
        <a href="https://tinyurl.com/ssmalaysia12" rel="nofollow noopener" target="_blank">
            <img layout="intrinsic" height="20px" width="20px"
                src="https://i.imgur.com/zTBzG2j.png" alt="BONUS <?php echo $BRANDS ?>">
            BONUS
        </a>
        <a href="https://tinyurl.com/ssmalaysia12" rel="nofollow noopener" target="_blank"
            class="js_live_chat_link live-chat-link">
            <img class="live-chat-icon" layout="intrinsic" height="20px" width="20px"
                src="https://i.imgur.com/DCmVQtK.png" alt="LIVE CHAT <?php echo $BRANDS ?>">
            LIVE CHAT
        </a>
    </div>
</body>