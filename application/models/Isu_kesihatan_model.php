...
class Isu_kesihatan_model extends CI_Model
{

    public function senarai_laporan($pelapor, $tahun)
    {
        $namaTable = 'kesihatan_'.$pelapor.'_'.$tahun;
        if($this->db->table_exists('kesihatan_'.$pelapor.'_'.$tahun) != FALSE){
            $this->db->select('*');
            ...
            $query = $this->db->get('kesihatan_'.$pelapor.'_'.$tahun);
            return $query->result();
        }
    }
    ...
    public function tambah()
    {
        ...
        $isu_kesihatan = $this->input->post('input_tajuk_isu');
        if(!empty($lain) && $isu_kesihatan == 'Lain-lain'){
            $isu_kesihatan = $lain;
        }
        $data = array(
            ...
            'isu_kesihatan' => $isu_kesihatan,
            'cadangan_intervensi' => $this->input->post('input_cadangan_intervensi'),
            'tapisan' => 'Terima'
        );
        $this->db->insert('kesihatan_'.$pelapor.'_'.date("Y"), $data);
    }
    ...
    {   
        ...
        if($this->db->table_exists($namaTable) == FALSE){
            ...
            $this->dbforge->create_table('kesihatan_'.$pelapor.'_'.$tahun, TRUE);
        }
