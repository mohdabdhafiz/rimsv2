...
class Isu_sosial_model extends CI_Model
{

    public function senarai_laporan($pelapor, $tahun)
    {
        $namaTable = 'sosial_'.$pelapor.'_'.$tahun;
        if($this->db->table_exists('sosial_'.$pelapor.'_'.$tahun) != FALSE){
            $this->db->select('*');
            ...
            $query = $this->db->get('sosial_'.$pelapor.'_'.$tahun);
            return $query->result();
        }
    }
    ...
    public function tambah()
    {
        ...
        $isu_sosial = $this->input->post('input_tajuk_isu');
        if(!empty($lain) && $isu_sosial == 'Lain-lain'){
            $isu_sosial = $lain;
        }
        $data = array(
            ...
            'isu_sosial' => $isu_sosial,
            'cadangan_intervensi' => $this->input->post('input_cadangan_intervensi'),
            'tapisan' => 'Terima'
        );
        $this->db->insert('sosial_'.$pelapor.'_'.date("Y"), $data);
    }
    ...
    {   
        ...
        if($this->db->table_exists($namaTable) == FALSE){
            ...
            $this->dbforge->create_table('sosial_'.$pelapor.'_'.$tahun, TRUE);
        }
