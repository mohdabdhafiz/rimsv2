...
<script>
  const tL = document.getElementById('tambahLokasi1');
  const kL = document.getElementById('kolumLokasi1');
  tL.addEventListener("click", function(){
    const c = document.createElement('div');
    c.innerHTML = "<div class='form-floating mt-3'><input type='text' name='inputLokasi[]' id='inputLokasi[]' class='form-control' placeholder='Lokasi Program'><label for='inputLokasi' class='form-label'>Lokasi Program:</label></div>";
    kL.appendChild(c);
  });
</script>
