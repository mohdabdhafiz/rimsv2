...
<div class="mb-3">
                <div class="row g-3">
                    <label class="form-label"><strong>2) Pilih Parlimen :</strong></label> 
                        <?php $senarai_parlimen = $data_parlimen->paparIkutNegeri($data_assign->assign($pengguna->pengguna_peranan_bil)->wcat_negeri); 
                            foreach($senarai_parlimen as $parlimen): ?>
                    <div class="col-12 col-lg-3 col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="inputCalonParlimenBil" id="inputCalonParlimenBil.<?php echo $parlimen->pt_bil; ?>" <?php if($parlimen->pt_bil == set_value('inputCalonParlimenBil')){ echo "checked"; } ?> value="<?php echo $parlimen->pt_bil; ?>">
                            <label class="form-check-label" for="inputCalonParlimenBil.<?php echo $parlimen->pt_bil; ?>">
