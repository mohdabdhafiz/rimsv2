...
<table class="table table-sm table-bordered table-striped table-hover">
    ...
    <tr>
        <td><?= $negeri->pt_negeri ?></td>
        <?php foreach($senarai_harian as $harian): 
            $senarai_parlimen = $data_harian_parlimen->senarai_parlimen_negeri($tarikh, $negeri->pt_negeri, $harian, $pru->pilihanraya_bil); ?>
        <td>
            <ol>
...
<?php foreach($senarai_negeri as $negeri): ?>
<tr>
    <td><?= $negeri->dun_negeri ?></td>
    <?php foreach($senarai_harian as $harian): 
            $senarai_dun = $data_harian_dun->senarai_dun_negeri($tarikh, $negeri->dun_negeri, $harian, $pru->pilihanraya_bil); ?>
        <td>
            <ol>
