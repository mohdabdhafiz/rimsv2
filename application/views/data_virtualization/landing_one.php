...
<head>
  ...
  <body>
      <div class="container">
          ...
          <h1 class="display-1">PENAMAAN CALON PILIHAN RAYA UMUM DEWAN NEGERI JOHOR KE 15</h1>
          </div>
          
          <div class="row">
              <div class="col-12 mb-4">
                    <h2 class="display-4">Penjuru</h2>
                    <div class="flourish-embed flourish-chart" data-src="visualisation/8544547"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
              </div>
              ...
              <div class="col-12 mb-4">
                    <h2 class="display-4" id="#senarai_calon">Senarai Pencalonan</h2>
                    <div class="flourish-embed flourish-table" data-src="visualisation/8544219"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
              </div>
