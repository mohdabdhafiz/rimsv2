...
if(strpos($sesi, "PPD") !== FALSE){
    ...
    $negeri = $data_assign->assign($pengguna->pengguna_peranan_bil)->wcat_negeri;
}
?>

<div class="container-fluid">
    <div class="p-3 border rounded mb-3">
        <h3>JANGKAAN CALON DUN <?php echo strtoupper($negeri); ?></h3>
    ...
    <div class="p-3 border rounded mb-3">
        ...
        <?php echo form_open('dun/proses_jangkaan_calon'); ?>
            <div class="mb-3">
                <div class="row g-3">
                    <label class="form-label"><strong>1) Pilih DUN :</strong></label> 
                        <?php 
                        if(strpos($this->session->userdata('peranan'), 'ppd') !== FALSE){
                            $senarai_dun = $data_dun->ikut_tugasan($pengguna->pengguna_peranan_bil); 
                        }else{
                            $senarai_dun = $data_dun->ikut_negeri($negeri); 
                        }
