...
<div class="p-3 border rounded mb-3">
    ...
    <?php echo form_open('lapis/proses_sosial'); ?>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="input_isu_sosial" class="form-label">5) Isu:</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Perpaduan">
                <label class="form-check-label" for="input_isu_sosial">
                    Perpaduan
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Pendidikan">
                <label class="form-check-label" for="input_isu_sosial">
                    Pendidikan
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Vandalisme">
                <label class="form-check-label" for="input_isu_sosial">
                    Vandalisme
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Lepak dalam kalangan remaja">
                <label class="form-check-label" for="input_isu_sosial">
                    Lepak dalam kalangan remaja
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Gelandangan">
                <label class="form-check-label" for="input_isu_sosial">
                    Gelandangan
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Penyalahgunaan dadah/gam/pil khayal.. dll">
                <label class="form-check-label" for="input_isu_sosial">
                    Penyalahgunaan dadah/gam/pil khayal.. dll
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Mat rempit">
                <label class="form-check-label" for="input_isu_sosial">
                    Mat rempit
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Penggangguran">
                <label class="form-check-label" for="input_isu_sosial">
                    Penggangguran
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Kemiskinan bandar">
                <label class="form-check-label" for="input_isu_sosial">
                    Kemiskinan bandar
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_isu_sosial" id="input_isu_sosial" value="Lain-lain">
                <label class="form-check-label" for="input_isu_sosial">
                    Lain-lain
                    
                </label>
                <textarea name="input_isu_sosial_lain" id="input_isu_sosial_lain" cols="10" rows="5" class="form-control"></textarea>
            </div>
        </div>
        <div class="mb-3">
