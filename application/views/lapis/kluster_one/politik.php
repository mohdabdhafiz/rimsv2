...
<div class="p-3 border rounded mb-3">
    ...
    <?php echo form_open('lapis/proses_politik'); ?>
        ...
        <div class="mb-3">
            <label for="input_ringkasan_isu" class="form-label">5) Ringkasan Isu:</label>
            <textarea name="input_ringkasan_isu" id="input_ringkasan_isu" cols="5" rows="5" class="form-control"></textarea>
        </div>
        <div class="mb-3">
            <label for="input_lokasi_isu" class="form-label">6) Lokasi Isu:</label>
            <input type="text" name="input_lokasi_isu" id="input_lokasi_isu" class="form-control">
        </div>
        <div class="mb-3">
            <label for="input_implikasi" class="form-label">7) Implikasi (Kesan kepada orang awam/komuniti/negara):</label>
            <textarea name="input_implikasi" id="input_implikasi" cols="5" rows="5" class="form-control"></textarea>
        </div>
        <div class="mb-3">
            <label for="input_penyelesaian" class="form-label">8) Cadangan Penyelesaian:</label>
            <textarea name="input_penyelesaian" id="input_penyelesaian" cols="5" rows="5" class="form-control"></textarea>
        </div>
        <div class="mb-3">
            <label for="input_agensi" class="form-label">9) Agensi Terlibat:</label>
            <input type="text" name="input_agensi" id="input_agensi" class="form-control">
        </div>
        <div class="mb-3">
            <label for="input_sentimen" class="form-label">10) Sentimen rakyat terhadap kerajaan:</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_sentimen" id="flexRadioDefault1" checked>
                <label class="form-check-label" for="flexRadioDefault1">
                    Positif
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_sentimen" id="flexRadioDefault2">
                <label class="form-check-label" for="flexRadioDefault2">
                    Neutral
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_sentimen" id="flexRadioDefault3">
