    ...
    <div class="card info-card sales-card">
        <div class="card-body">
            <h5 class="card-title">Bilangan Pelapor</h5>
            <div class="d-flex align-items-center mb-3">
                <div class="ps-3">
                    <h6 id="jumlah-pelapor"><?= $statistik->jumlah_pelapor ?></h6>
                </div>
            </div>
            <a href="<?= site_url('sentimen/senaraiPelapor') ?>" class="mb-0 btn btn-sm btn-outline-primary w-100">Senarai Pelapor</a>
        </div>
    </div>
</div>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateDashboard() {
        ...
        .then(data => {
            ...
            // 1. UPDATE KAD KPI
            document.getElementById('jumlah-pelapor').innerText = data.kpi.jumlah_pelapor;
