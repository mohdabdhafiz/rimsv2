<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><?= anchor('konfigurasi/dun', 'DUN') ?></li>
...
<div class="p-3 border rounded mb-3">
    ...
    <p><strong>Operasi Set Akaun PPD untuk dun <?= $dun->dun_nama ?>:</strong></p>
    <?php echo validation_errors(); ?>
    <?php echo form_open('konfigurasi/dun_proses_set'); ?>
    <div class="mb-3">
