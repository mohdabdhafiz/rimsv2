...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title">Maklumat telah dihantar untuk membuat semakan semula. Proses seterusnya akan diselesaikan oleh pelapor.</h1>


    <div class="row g-3 mt-3">
        <div class="col-12">
            <?php echo anchor('lapis/statusPenghantaran/'.$klusterBil, 'Kembali', "class='btn btn-sm btn-outline-warning w-100'"); ?>
        </div>
    </div>
