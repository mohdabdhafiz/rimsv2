            ...
            <?php echo form_open('pengguna/proses_kemaskini'); ?>
                ...
                <div class="form-floating mb-3">
                    <select class="form-control" name="input_jawatan" id="input_jawatan">
                        ...
                        <option value="Pegawai Penerangan Gred S54" <?php if($penggunaKemaskini->pekerjaan == 'Pegawai Penerangan Gred S54') { echo "selected"; } ?>>Pegawai Penerangan Gred S54</option>
                        <option value="Pegawai Penerangan Gred S52" <?php if($penggunaKemaskini->pekerjaan == 'Pegawai Penerangan Gred S52') { echo "selected"; } ?>>Pegawai Penerangan Gred S52</option>
                        <option value="Pegawai Penerangan Gred S48" <?php if($penggunaKemaskini->pekerjaan == 'Pegawai Penerangan Gred S48') { echo "selected"; } ?>>Pegawai Penerangan Gred S48</option>
