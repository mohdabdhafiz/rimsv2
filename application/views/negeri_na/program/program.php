...
foreach($senaraiProgram as $program): 
  ...
  strpos($st, 'DRAF GSPI NEGERI') !== FALSE || 
  strpos($st, 'PENGESAHAN HANTAR PP GSPI NEGERI') !== FALSE && $pengguna->bil == $akaunPp->bil || 
  strpos($st, 'PENGESAHAN PERANCANGAN PP GSPI NEGERI') !== FALSE  && $pengguna->bil == $akaunPp->bil || 
  (strpos($st, 'PENGESAHAN PERANCANGAN PP PKPM NEGERI') !== FALSE) ||
  (strpos($st, 'PENGESAHAN HANTAR PP PKPM NEGERI'));
  //DELETE CONDITION
  $bolehPadam = FALSE;
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                        <i class="bi bi-x-octagon"></i>
                        Tutup</button>
                      <?= form_open('program/sahRancangHq') ?>
                        <input type="hidden" name="inputProgramBil" value="<?= $program->program_bil ?>">
                        <input type="hidden" name="inputPengguna" value="<?= $pengguna->bil ?>">
                        <button type="submit" class="btn btn-outline-primary shadow-sm">
                        <i class="bi bi-reply"></i>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                        <i class="bi bi-x-octagon"></i>
                        Tutup</button>
                      <?= form_open('program/sahLaksanaHq') ?>
                        <input type="hidden" name="inputProgramBil" value="<?= $program->program_bil ?>">
                        <input type="hidden" name="inputPengguna" value="<?= $pengguna->bil ?>">
                        <button type="submit" class="btn btn-outline-primary shadow-sm">
                        <i class="bi bi-reply"></i>
