        ...
        <div class="p-3 border rounded">
            ...
            <?php echo form_open('pengguna/proses_tambah'); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="input_tempat" id="input_tempat" class="form-control">
                </div>
...
<script>
    ...
    async function setTambah()
    {
        const data = await getTambah();
        document.getElementById("tambah_akaun").innerHTML = data;
    }

    async function getTambah()
    {
        const response = await fetch('<?php echo base_url(); ?>index.php/pengguna/tambah_akaun');
        const data = await response.text();
        return data;
    }
