...
<div class="p-3 border rounded mb-3">
    ...
    $hari_ini = date('Y-m-d');
        ...
        <?php 
        $harian = $data_harian->hari_ini($dun->dun_bil, $pru->pilihanraya_bil, $tarikh);
        ...
        $harian_waktu = $harian->harian_waktu;
        ?>
        <div class="table-responsive">
            <table class="table table-border table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td><?= date_format(date_create($harian_waktu), "d.m.Y H:i:s") ?></td>
                </tr>
            </table>
        </div>
        <?php
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ?></td>
                        <td style="<?php if($seratus > 100){ echo "background-color:red; color:white;"; } ?><?php if($seratus < 100){ echo "background-color:yellow; color:black;"; } ?>"><?php echo number_format($seratus, 2, ".", ","); ?>%</td>
