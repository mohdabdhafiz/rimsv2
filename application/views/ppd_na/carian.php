            ...
            <div class="row g-3">
                <div class="col-12 col-lg-4 col-md-6 col-sm-12">
                    <div class="form-floating">
                        <select name="inputNaratif" id="inputNaratif" class="form-control">
                            <option value="">Sila Pilih..</option>
                            <?php foreach($senaraiNaratif as $naratif): ?>
                                <option value="<?= $naratif->senarai_kandungan_kandungan ?>"><?=  strtoupper($naratif->senarai_kandungan_kandungan) ?></option>
                            <?php endforeach; ?>
                        </select>
                        <label for="inputNaratif" class="form-label">1. Naratif / Tajuk Hebahan / Ceramah</label>
                    </div>
                </div>
                <div class="col-12 col-lg-4 col-md-6 col-sm-12">
                    <div class="form-floating">
                        <select name="inputJenis" id="inputJenis" class="form-control">
                            ...
                            <?php foreach($senaraiJenis as $jenis): ?>
                                <option value="<?= $jenis->jt_bil ?>"><?= strtoupper($jenis->jt_nama) ?></option>
                            <?php endforeach; ?>
                        </select>
                        <label for="inputJenis" class="form-label">2. Nama Program</label>
                    </div>
                </div>
                <div class="col-12 col-lg-4 col-md-6 col-sm-12">
                    <div class="form-floating">
                        <select name="inputDaerah" id="inputDaerah" class="form-control">
                            ...
                            <?php foreach($senaraiDaerah as $daerah): ?>
                                <option value="<?= $daerah->bil ?>"><?= strtoupper($daerah->nama) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-floating">
                        <select name="inputParlimen" id="inputParlimen" class="form-control">
                            ...
                            <?php foreach($senaraiParlimen as $parlimen): ?>
                                <option value="<?= $parlimen->pt_bil ?>"><?= strtoupper($parlimen->pt_nama) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-floating">
                        <select name="inputDun" id="inputDun" class="form-control">
                            ...
                            <?php foreach($senaraiDun as $dun): ?>
                                <option value="<?= $dun->dun_bil ?>"><?= strtoupper($dun->dun_nama) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-floating">
                        <select name="inputStatus" id="inputStatus" class="form-control">
                            ...
                            <?php foreach($senaraiStatus as $status): ?>
                                <option value="<?= $status->program_status ?>"><?= strtoupper($status->program_status) ?></option>
                            <?php endforeach; ?>
                        </select>
