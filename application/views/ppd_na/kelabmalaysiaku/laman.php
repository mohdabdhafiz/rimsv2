...
<div class="pagetitle">
   ...
   <div class="p-3 border rounded bg-white shadow-sm">
    ...
    <div id="rumusanNegeri">
        <h3 class="text-primary">RUMUSAN MENGIKUT NEGERI YANG BERSTATUS AKTIF</h3>
        <div class="table-responsive">
            <table class="table table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><?= $rumusan->nt_nama ?></td>
                        <td class="text-center"><?= number_format($rumusan->jumlahKelab, 0, ".", ",") ?></td>
                        <td class="text-center"><?= number_format($rumusan->jumlahSekolah, 0, ".", ",") ?></td>
                        <td class="text-center"><?= number_format($rumusan->jumlahAhli, 0, ".", ",") ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
                <tfoot>
                    <tr>
                        <th>JUMLAH</th>
                        <th class="text-center"><?= number_format($jumlahKeseluruhanKelab, 0, ".", ",") ?></th>
                        <th class="text-center"><?= number_format($jumlahKeseluruhanSekolah, 0, ".", ",") ?></th>
                        <th class="text-center"><?= number_format($jumlahKeseluruhanAhli, 0, ".", ",") ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
