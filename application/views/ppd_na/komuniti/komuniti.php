...
<div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="<?= site_url('komuniti/bil/'.$komuniti->komuniti_bil) ?>"><?= strtoupper($komuniti->komuniti_nama) ?></a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating mb-3">
                            <select name="inputNegeriBil" id="inputNegeriBil" class="form-control">
                                <option value="<?= $komuniti->komuniti_negeri ?>" selected ><?= strtoupper($komuniti->nt_nama) ?></option>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <select name="inputDaerahBil" id="inputDaerahBil" class="form-control">
                                ...
                                <option value="<?= $daerah->bil ?>" <?php if($daerah->bil == $komuniti->komuniti_daerah){ echo "selected"; } ?>><?= strtoupper($daerah->nama) ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <select name="inputParlimenBil" id="inputParlimenBil" class="form-control">
                                ...
                                <option value="<?= $parlimen->pt_bil ?>" <?php if($parlimen->pt_bil == $komuniti->komuniti_parlimen){ echo "selected"; } ?>><?= strtoupper($parlimen->pt_nama) ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <select name="inputDunBil" id="inputDunBil" class="form-control">
                                ...
                                <option value="<?= $dun->dun_bil ?>" <?php if($dun->dun_bil == $komuniti->komuniti_dun){ echo "selected"; } ?>><?= strtoupper($dun->dun_nama) ?></option>
                                <?php endforeach; ?>
                            </select>
