...
<div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= site_url('komuniti/pilihParlimen/'.$daerah->bil) ?>">Parlimen</a></li>
                <li class="breadcrumb-item active"><a href="<?= site_url('komuniti/pilihParlimen/'.$daerah->bil) ?>">DUN</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-lg-3 col-md-4 col-sm-6 text-center">
                    <?= form_open('komuniti/daftarKomunitiDun') ?>
