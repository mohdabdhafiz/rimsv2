...
<div class="pagetitle">
    ...
    ?>
        ...
        <?php if(count($senaraiParlimen) > 0): ?>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="input_tajuk_isu" id="input_tajuk_isu<?= $k->nama ?>" value="<?= $k->nama ?>">
                <label class="form-check-label" for="input_tajuk_isu<?= $k->nama ?>">
                <?= $k->nama ?><br>
        ...
        <div class="mb-3">
            ...
            <textarea name="input_cadangan_intervensi" id="input_cadangan_intervensi" class="form-control quill-editor-bubble" cols="30" rows="10" style="height:200px;"></textarea>
        </div>
        <div class="mb-3">
            <label for="inputKategori" class="form-label"><?= $bilangan++ ?>) Kategori Isu:</label>
