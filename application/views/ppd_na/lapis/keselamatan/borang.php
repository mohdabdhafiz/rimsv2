            ...
            <div class="card-body">
                ...
                echo form_open('lapis/proses_keselamatan'); ?>
                    ...
                    <?php if(!empty($senarai_parlimen)): ?>
                        <div class="mb-3">
                            <label for="input_parlimen" class="form-label"><?= $nomborSoalan++ ?>) Pilih Parlimen:</label>
                    ...
                    <?php if(!empty($senarai_dun)): ?>
                        <div class="mb-3">
                            <label for="input_dun" class="form-label"><?= $nomborSoalan++ ?>) Pilih DUN:</label>
                    ...
                    <?php if(!empty($senaraiPdm)): ?>
                        <div class="mb-3">
                            <label for="input_pdm" class="form-label"><?= $nomborSoalan++ ?>) Pilih Daerah Mengundi:</label>
                    ...
                    <div class="mb-3">
                        <label for="input_tajuk_isu" class="form-label"><?= $nomborSoalan++ ?>) Isu:</label>
                        <?php foreach($senaraiKategori as $k): ?>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="input_tajuk_isu" id="input_tajuk_isu_<?= htmlspecialchars($k->nama) ?>" value="<?= $k->nama ?>">
                            <label class="form-check-label" for="input_tajuk_isu_<?= htmlspecialchars($k->nama) ?>">
                                <?= $k->nama ?>
                        ...
                        <div class="form-check">
                            ...
                            <textarea name="input_tajuk_isu_lain" id="input_tajuk_isu_lain_textarea" cols="10" rows="5" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="input_lokasi_isu" class="form-label"><?= $nomborSoalan++ ?>) Lokasi Isu:</label>
                        <input type="text" name="input_lokasi" id="input_lokasi_isu" class="form-control" required>
                        <div class="row g-3 mt-1">
                            <div class="col-12 col-lg-6 col-md-6 col-sm-12">
                                <div class="form-floating">
                                    <input type="text" name="input_latitude" id="inputLatitude" class="form-control" placeholder="a) Latitude Lokasi:">
                                    <label for="inputLatitude" class="form-label">a) Latitude Lokasi:</label>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6 col-md-6 col-sm-12">
                                <div class="form-floating">
                                    <input type="text" name="input_longitude" id="inputLongitude" placeholder="b) Longitude Lokasi:" class="form-control">
                    ...
                    <div class="mb-3">
                        <label for="input_cadangan_intervensi" class="form-label"><?= $nomborSoalan++ ?>) Cadangan Intervensi:</label>
                        <textarea name="input_cadangan_intervensi" id="input_cadangan_intervensi" cols="30" rows="10" class="form-control" style="height:100px;"></textarea>
                    </div>
                    <div class="mb-3">
                        <div class="form-check">
