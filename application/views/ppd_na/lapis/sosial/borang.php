...
<div class="pagetitle">
    ...
    <?php $this->load->view("ppd_na/lapis/peringatan"); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="input_lokasi" id="input_lokasi" class="form-control">
        ...
        <div class="mb-3">
            ...
            <textarea name="input_cadangan_intervensi" id="input_cadangan_intervensi" cols="30" rows="10" class="form-control" style="height:200px;"></textarea>
        </div>
