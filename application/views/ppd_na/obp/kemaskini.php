                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 mt-3">
                                <div class="d-flex justify-content-center mb-4">
                                    <?= form_open_multipart('obp/proses_kemaskini_gambar') ?>
                                    <?php     
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <label for="inputGambarObp" class="col-sm-2 col-form-label">Muat Naik
                                            Gambar</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="file" id="inputGambarObp" name="inputGambarObp">
                                        </div>
                                    </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Address"
                                                        ...
                                                        placeholder="Alamat"><?= $obp->obp_alamat ?></textarea>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-floating">
                                                    <input type="email" class="form-control" id="inputE-mail"
                                                        name="inputE-mail" value="<?= $obp->obp_email ?>" placeholder="E-mel">
