                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <select name="inputNegeri" id="inputNegeri" class="form-control" required>
                                            ...
                                            <?php 
                                            if(strtoupper($negeri->nt_nama) == 'SARAWAK'){
                                                $requireParlimen = '';
                                            }
                                                endif;
                                            endforeach; ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <select name="inputParlimen" id="inputParlimen" class="form-control" <?= $requireParlimen ?> >
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <select name="inputDun" id="inputDun" class="form-control" <?php if(!empty($senaraiDun)){ echo 'required'; } ?>>
