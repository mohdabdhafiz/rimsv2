    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title">Senarai Program Berstatus <?= $status ?></h5>
                <div class="btn-group" role="group" aria-label="Operasi Senarai Laporan">
                    <?php $status = bin2hex($status); ?>
                    <a href="<?= site_url('program/muatTurunStatus/'.$status) ?>" class="btn btn-outline-primary shadow-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Muat Turun Senarai Program">
                ...
                <table class="table datatable">
                    <thead>
                        <tr>
                            ...
                            <th>HEBAHAN / CERAMAH / SKOP NARATIF</th>
                            <th>NAMA PROGRAM</th>
                            <th>NEGERI</th>
                            <th>DAERAH</th>
                            <th>PARLIMEN</th>
