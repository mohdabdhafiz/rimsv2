    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title">Grading <?= $dun->dun_nama ?> untuk <?= $pilihanraya->pilihanraya_singkatan ?></h5>
                <?= form_open('grading/binaDun') ?>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $jumlah++ ?></td>
                            <td><?= $h->harian_tarikh ?></td>
                            <td>
                                <?php echo $h->harian_grading; ?>
                            </td>
                            <td><?= $h->parti_nama ?> (<?= $h->parti_singkatan ?>)</td>
                            <td>
                                <a href="<?= site_url('grading/harianDun/'.$h->harian_bil) ?>" class="btn btn-outline-primary shadow-sm">Lihat</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
