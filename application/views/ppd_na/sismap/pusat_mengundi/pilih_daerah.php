    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Senarai Daerah</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">Senarai Pusat Daerah Mengundi</h5>
                            </div>

                            <!-- List group with Links and buttons -->
                            <div class="list-group">
                                <?php foreach($senaraiDaerah as $d): ?>
                                <a type="button" class="list-group-item list-group-item-action" aria-current="true" href="<?= site_url('pusat_mengundi/senaraiMengundi/'.$d->ppt_bil) ?>">
                                    <?= $d->ppt_nama ?>
                                </a>
                                <?php endforeach; ?>
