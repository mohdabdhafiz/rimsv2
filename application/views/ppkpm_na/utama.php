<?php 
$this->load->view('ppkpm_na/susunletak/atas');
$this->load->view('ppkpm_na/susunletak/sidebar');
$this->load->view('ppkpm_na/susunletak/navbar');
?>
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= site_url('ppkpm/perancanganProgram') ?>" class="btn btn-outline-primary shadow-sm">
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= site_url('ppkpm/pelaksanaanProgram') ?>" class="btn btn-outline-primary shadow-sm">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
                    ...
                    <?php foreach($senaraiNegeri as $negeri): ?>
                        <div class="col-12 col-lg-3 col-md-3 col-sm-6">
                            <div class="d-flex justify-content-start align-items-center">
                                <img src="./assets/bendera/<?= $negeri->nt_nama_fail ?>" alt="<?= $negeri->nt_bil ?>" class="img-fluid" style="width:50px; height:auto;">
                                <div class="ms-3">
                                    <?= $negeri->nt_nama ?>
                                </div>
                            </div>
...
<?php $this->load->view('ppkpm_na/susunletak/bawah'); ?>