...
<div class="card">
    <div class="card-body">
        <h1 class="card-title">Operasi ADMIN</h1>
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>Menukar status laporan</td>
                        <td>
                            <a href="<?= site_url('program/tukarStatusLaporan/'.$program->program_bil) ?>" class="btn btn-outline-primary shadow-sm">Tukar</a>
                        </td>
                    </tr>
                    <tr>
                      <td>Menukar pelapor</td>
                      <td><a href="<?= site_url("program/tukarPelaporLaporan/".$program->program_bil) ?>" class="btn btn-outline-primary shadow-sm">Tukar Pelapor</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
