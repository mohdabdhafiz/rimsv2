<div class="container-fluid">
    <div class="p-3 border rounded mb-3">
        <h1 class="display-1"><?php echo strtoupper($negeri->nt_nama); ?></h1>
    ...
    <div class="p-3 border rounded mb-3">
        ...
        <p class="small text-muted">Senarai Jangkaan Calon Parlimen PRU15 Mengikut Parlimen <?php echo $negeri->nt_nama; ?></p>
        <div class="table-responsive mt-3">
            <table class="table table-hover table-bordered">
                <tr class="bg-secondary text-white">
                    <th class="text-center">BIL</th>
                    <th>SENARAI PARLIMEN</th>
                    <th class="text-center">BILANGAN JANGKAAN CALON PARLIMEN PRU15 (ORANG)</th>
                </tr>
                <?php $count = 1; 
                $jumlah_calon = 0;
                ...
                <tr>
                    ...
                    <td><?php echo anchor("laporan/maklumat_parlimen_pru/".$parlimen->pt_bil, $parlimen->pt_nama); ?></td>
                    <td class="text-center"><?php $bilangan_calon = count($data_wc->calon_parlimen($parlimen->pt_bil, $pilihanraya_bil));
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                <tr class="bg-secondary text-white">
                    ...
                    <th valign="middle" class="text-center">UMUR</th>
                    <th valign="middle" class="text-center">JANTINA</th>
                </tr>
                <?php $count = 1; 
                foreach($data_wc->semua_negeri($negeri->nt_nama, $pilihanraya_bil) as $calon): ?>
                    <tr>
                        ...
                        <td valign="center" class="text-center">
                            <?php $nama_foto = $data_foto->foto($calon->ahli_foto); ?>
                        ...
                        <td valign="middle" class="text-center"><?php echo $calon->ahli_nama; ?></td>
                        ...
                        <td valign="middle" class="text-center"><?php echo $calon->ahli_umur; ?></td>
                        <td valign="middle" class="text-center"><?php echo $calon->ahli_jantina; ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        </div>
