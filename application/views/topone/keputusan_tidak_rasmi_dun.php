...
<?php foreach($senarai_dun as $dun): 
    $rekod = $data_rekod->rekod_terakhir_dun($dun->dun_bil, $pru->pilihanraya_bil); 
    ?>
    <div class="col-12 col-lg-6 d-flex align-items-stretch">
        <div class="p-3 border rounded w-100">
            <?php
                $ls = $data_calon->jangkaan($dun->dun_bil, $pru->pilihanraya_bil);
                if(!empty($ls)){ 
            ...
            <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <th class="text-center" valign="middle"><?= $rekod->rpdt_peti_undi ?></th>
                        </tr>
                    </table>
                    <p>Kemaskini terakhir: <?= $rekod->rpdt_waktu ?></p>
                    <?php } ?>
        </div>
    </div>
<?php endforeach; ?>
