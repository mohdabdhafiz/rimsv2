...
<div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= site_url('konfigurasi/senaraiagensi') ?>">Senarai Agensi Program</a></li>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <span class="small"><strong>Agensi Program</strong></span>
                            <br><?= $agensi->senarai_agensi_agensi ?>
                        </td>
                    </tr>
                </table>
            </div>
            <?= form_open('konfigurasi/padamSenaraiagensi') ?>
