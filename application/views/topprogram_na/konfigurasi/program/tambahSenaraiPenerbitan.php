...
<div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Maklumat Penerbitan</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
...
<div class="">
    ...
    <div class="card">
        <div class="card-body">
            <h1 class="card-title">Tambah Maklumat Penerbitan</h1>
            <?= form_open('konfigurasi/tambahSenaraipenerbitan') ?>
                      <div class="form-floating mb-3">
                        <input type="text" name="inputpenerbitan" id="inputpenerbitan" class="form-control" placeholder="Nama Penerbitan">
                        <label for="inputpenerbitan" class="form-label">Nama Penerbitan</label>
                      </div>
