...
<div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Maklumat Agensi</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
...
<div class="">
    ...
    <div class="card">
        <div class="card-body">
            <h1 class="card-title">Tambah Maklumat Agensi</h1>
            <?= form_open('konfigurasi/tambahSenaraiagensi') ?>
                      <div class="form-floating mb-3">
                        <input type="text" name="inputagensi" id="inputagensi" class="form-control" placeholder="Nama Agensi">
                        <label for="inputagensi" class="form-label">Nama Agensi</label>
                      </div>
