        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= site_url('peranan/tambahPenugasanManual') ?>" class="btn btn-outline-primary shadow-sm">Menetapkan Tugas Negeri</a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm datatable">
                        ...
                        <tbody>
                            <?php foreach($senaraiTugasNegeri as $stn): ?>
                            <tr>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Padam Maklumat Tugasan Peranan Mengikut Negeri</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <?= form_open('peranan/padamTugasNegeri') ?>
                    <div class="modal-body">
                        <div class="d-flex justify-content-center">
                            <div class="p-3">
                                ...
                                <p>
                                    <strong>Tugasan Negeri:</strong><br>
                                    <?= $stn->nt_nama ?>
                                </p>
                            </div>
                        </div>
