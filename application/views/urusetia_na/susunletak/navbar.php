<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="<?= site_url('utama') ?>" class="logo d-flex align-items-center">
      <img src="<?= base_url('assets/img/logo_japen.png') ?>" alt="">
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          <span class="d-none d-md-block dropdown-toggle ps-2"><?= $this->session->userdata('pengguna_nama') ?? 'Urusetia' ?></span>
        </a><ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          <li class="dropdown-header">
            <h6><?= $this->session->userdata('pengguna_nama') ?? 'Urusetia' ?></h6>
            <span><?= $this->session->userdata('peranan') ?? 'URUSETIA' ?></span>
          </li>
