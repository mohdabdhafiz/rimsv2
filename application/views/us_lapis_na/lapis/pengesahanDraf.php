...
<main id="main" class="main">
    ...
    <p>Adakah anda pasti untuk pelapor membuat semakan semula laporan ini?</p>
    <div class="row g-1">
        <div class="col-auto">
    <p>
    ...
    <div class="row g-1">
        <div class="col-auto">
            <?php echo form_open('lapis/laporanTidakTerima'); ?>
                <input type="hidden" name="input_pengesahan" value="Ya">
                        ...
                        <button type="submit" class="btn btn-outline-warning shadow-sm">Perlu Semakan Semula</button>
                        </form>
        </div>
        <div class="col-auto">
