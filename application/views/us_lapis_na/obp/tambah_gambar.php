    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Muat Naik Gambar</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?= form_open_multipart('obp/proses_tambah_gambar') ?>
                        <div class="mb-3 mt-3">

                        <div class="row mb-3">
                  <label for="gambarObp" class="col-sm-2 col-form-label">Muat Naik Gambar</label>
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="gambarObp" name="gambarObp">
                  </div>
                </div>
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-center">
                                        <div>
                                            ...
                                            <input type="hidden" name="inputObpId" value="<?php echo $obp->obp_id; ?>">
