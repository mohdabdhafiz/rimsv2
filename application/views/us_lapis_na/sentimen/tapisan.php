...
<div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Senarai Tapisan Laporan Khas Sentimen</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <table class="table table-bordered datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $lks->stTapisan ?></td>
                            <td>
                                <a href="<?= site_url('sentimen/bil/'.$lks->stBil) ?>" class="btn btn-outline-success shadow-sm">Lihat</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
