...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url() ?>">RIMS@OBP</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row row-cols-5">
                 ...
                 <!-- Negeri Card -->
                 <div class="col-12 col-lg col-sm-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6 id="bilanganKeseluruhan">0</h6>
                            ...
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <?php foreach($negeri as $n): 
                                        $negeriDefault = $n->nt_nama; ?>
                                    <li><a class="dropdown-item" href="#" onclick="ubahNegeriPilihan('<?= $n->nt_nama ?>')"><?= $n->nt_nama ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>

                            <div class="card-body">
                                <h5 class="card-title">Negeri <span id="negeriPilihan"><?= $negeriDefault ?></span></h5>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6 id="bilanganNegeriPilihan">0</h6>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    $bilanganObp = 0;
                                                    $senaraiPeranan = $dataPeranan->senarai();
                                                    foreach($senaraiPeranan as $peranan){
                                                        $senaraiObp = $dataObp->senaraiObpIkutNegeriPeranan($n->nt_bil, $peranan->peranan_bil);
                                                        if(!empty($senaraiObp)){
...
<?php
$this->load->view('us_obp_na/susunletak/bawah');
?>

<script>

    const bilanganKeseluruhan = document.getElementById('bilanganKeseluruhan');
    
    async function getBilanganKeseluruhan()
    {
        const response = await fetch('<?php echo base_url(); ?>index.php/obp/bilanganKeseluruhan');
        const data = await response.text();
        var num = data;
        for(i = 0; i <= num; i++){
            bilanganKeseluruhan.innerText = i;    
        }
    }

    const negeriPilihan = document.getElementById('negeriPilihan');
    const bilanganNegeriPilihan = document.getElementById('bilanganNegeriPilihan');

    function ubahNegeriPilihan(negeri){
        negeriPilihan.innerText = negeri;
        getBilanganNegeri();
    }

    async function getBilanganNegeri()
    {
        const hantarData = new FormData();
        hantarData.append("namaNegeri", negeriPilihan.innerText);
        const response = await fetch('<?php echo base_url(); ?>index.php/obp/bilanganNegeriPilihan', {
            method: 'POST',
            body: hantarData
        });
        const data = await response.text();
        bilanganNegeriPilihan.innerText = data;
    }

    setInterval(() => {
        getBilanganKeseluruhan();   
        getBilanganNegeri();
    }, 2000);
