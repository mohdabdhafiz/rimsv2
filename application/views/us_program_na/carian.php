                    ...
                    <div class="form-floating">
                        <select name="inputDaerah" id="inputDaerah" class="form-control">
                            ...
                            <?php foreach($senaraiDaerah as $daerah): ?>
                                <option value="<?= $daerah->bil ?>"><?= $daerah->nt_nama ?> - <?= strtoupper($daerah->nama) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-floating">
                        <select name="inputParlimen" id="inputParlimen" class="form-control">
                            ...
                            <?php foreach($senaraiParlimen as $parlimen): ?>
                                <option value="<?= $parlimen->pt_bil ?>"><?= $parlimen->nt_nama ?> - <?= strtoupper($parlimen->pt_nama) ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-floating">
                        <select name="inputDun" id="inputDun" class="form-control">
                            ...
                            <?php foreach($senaraiDun as $dun): ?>
                                <option value="<?= $dun->dun_bil ?>"><?= $dun->nt_nama ?> - <?= strtoupper($dun->dun_nama) ?></option>
                            <?php endforeach; ?>
                        </select>
