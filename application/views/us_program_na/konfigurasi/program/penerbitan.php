    ...
    <div class="card">
        <div class="card-body">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            ...
                            <br><?= $penerbitan->nama_penuh ?>
                        </td>
                        <td>
                            <span class="small"><strong>Tarikh Kemasukan Data</strong></span>
                            <br><?= $penerbitan->senarai_penerbitan_pengguna_waktu ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan='3'>
                            <span class="small"><strong>Penerbitan</strong></span>
            ...
            <div class="row g-3">
                ...
                <a href="<?= site_url('konfigurasi/kemaskiniSenaraipenerbitan/'.$penerbitan->senarai_penerbitan_bil) ?>" class="btn btn-outline-primary w-100 shadow-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kemaskini Maklumat">
                                        <i class="bi bi-gear"></i>
                                    Kemaskini Maklumat
                                    </a>
                </div>
                <div class="col-12 col-lg-6 col-md-6">
                <a href="<?= site_url('konfigurasi/confirmPadamPenerbitan/'.$penerbitan->senarai_penerbitan_bil) ?>" class="btn btn-outline-danger w-100 shadow-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Padam Maklumat">
