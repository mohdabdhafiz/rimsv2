...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
        <p class="card-title"><strong>MAKLUMAT PILIHAN RAYA</strong></p>
    ...
    <p class="card-title"><strong>TAMBAH DALAM SENARAI <?php echo ($pr->pilihanraya_jenis == "PARLIMEN") ? "PARLIMEN" : "DUN"; ?> YANG BERTANDING DALAM <?php echo strtoupper($pr->pilihanraya_nama); ?></strong></p>
    <?php 
    $proses = "";
    $kawasan = "";
    ...
    <?php if(!empty($senarai_parlimen_dun)){ ?>
        <div class="card">
            <div class="card-body">
        <p class="card-title"><strong>SENARAI KAWASAN YANG BERTANDING</strong></p>
