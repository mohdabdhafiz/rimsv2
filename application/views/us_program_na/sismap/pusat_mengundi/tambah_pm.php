                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <select name="inputNegeri" id="inputNegeri" class="form-control" required>
                                            ...
                                            <option value="">Pilihan Raya 1</option>
                                            <option value="">Pilihan Raya 2</option>
                                            <option value="">Pilihan Raya 3</option>
                                        </select>
                                        <label for="inputNegeri">Senarai Pilihan Raya</label>
                                    </div>
                                </div>
                                <form class="row g-10">
                                    <div class="col-md-12">
