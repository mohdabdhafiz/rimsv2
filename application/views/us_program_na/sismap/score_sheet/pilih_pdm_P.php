                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 30%;" class="text-end">
                                                <a type="button" class="btn btn-outline-success"
                                                    ...
                                                    title="Isi Helaian Mata" href="<?php echo site_url('scoresheet/isiScore/'.$sp->ppt_bil); ?>">
                                                    <i class="bi bi-vector-pen"></i>
                                                </a>
                                                <span data-bs-toggle="modal" data-bs-target="#editModal<?= $sp->bil ?>">
                                                ...
                                                <a type="button" class="btn btn-outline-secondary"
                                                    href="<?php echo site_url('scoresheet/maklumat/'.$sp->bil); ?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <!-- Basic Modal -->
                                                <div class="modal fade text-start" id="editModal<?= $sp->bil ?>"
