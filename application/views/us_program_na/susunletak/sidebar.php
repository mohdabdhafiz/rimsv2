...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="program-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="<?= site_url('program/senaraiIndividu') ?>">
          <i class="bi bi-circle"></i>
          <span>Senarai Laporan (Individu)</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="<?= site_url('jit') ?>">
          <i class="bi bi-circle"></i>
          <span>JOM EXTRACTION (JET)</span>
        </a>
      </li>
      <li>
        <a href="<?= site_url('data/naratifProgram') ?>">
          <i class="bi bi-circle"></i>
          <span>NARATIF x PROGRAM</span>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="nav-item">
    ...
    <ul id="komuniti-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="<?= site_url('komuniti/libatUrus') ?>">
          <i class="bx bi-circle"></i>
          <span>Laporan Libat Urus Komuniti</span>
        </a>
      </li>
    </ul>
  </li>
...
<li class="nav-item">
  <a href="#" class="nav-link collapsed" data-bs-target="#kerangka-nav" data-bs-toggle="collapse">
    <i class="bi bi-gear"></i>
    <span>KERANGKA NARATIF</span>
    <i class="bi bi-chevron-down ms-auto"></i>
  </a>
  <ul id="kerangka-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
    <li>
      <a href="<?= site_url('kerangkaNaratif/senarai') ?>">
        <i class="bi bi-circle"></i>
        <span>Senarai</span>
      </a>
    </li>
    <li>
      <a href="<?= site_url('kerangkaNaratif/tambah') ?>">
        <i class="bi bi-circle"></i>
        <span>Tambah</span>
      </a>
    </li>
    <li>
      <a href="<?= site_url('kerangkaNaratif/senaraiNaratif') ?>">
        <i class="bi bi-circle"></i>
        <span>Senarai Naratif Mengikut Kerangka Naratif</span>
      </a>
    </li>
  </ul>
</li>
...
<li class="nav-item">
  <a href="#" class="nav-link collapsed" data-bs-target="#kandungan-nav" data-bs-toggle="collapse">
    <i class="bi bi-gear"></i>
    <span>SENARAI NARATIF / TAJUK HEBAHAN / CERAMAH PROGRAM</span>
    <i class="bi bi-chevron-down ms-auto"></i>
  </a>
