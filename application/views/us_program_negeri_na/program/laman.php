...
<div class="pagetitle">
    ...
    <div class="card">
        <div class="card-body">
            <h1 class="card-title">Rumusan Laporan Program Keseluruhan Negeri Tahun <?= date("Y") ?></h1>
            <div class="row g-3">
                <?php foreach($senaraiRumusanProgram as $program): 
                    $sendStatus = bin2hex($program->program_status); ?>
                <div class="col col-lg-4 col-md-4 col-sm-6 d-flex align-items-strech">
                    <div class="p-3 border rounded d-flex justify-content-center align-items-center w-100">
                        <div class="d-flex flex-column text-center w-100">
                            ...
                            <a href="<?= site_url('program/mengikutDaerah/'.$sendStatus) ?>" class="mt-3 btn btn-sm btn-outline-primary w-100 shadow-sm">Senarai Daerah</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
