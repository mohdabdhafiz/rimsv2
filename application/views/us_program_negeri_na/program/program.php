...
foreach($senaraiProgram as $program): 
  ...
  strpos($st, 'DRAF NEGERI') !== FALSE || 
  strpos($st, 'PENGESAHAN HANTAR NEGERI') !== FALSE || 
  strpos($st, 'PENGESAHAN PERANCANGAN NEGERI') !== FALSE || 
  (strpos($st, 'PENGESAHAN PERANCANGAN PP PKPM NEGERI') !== FALSE && $pengguna->bil == $akaunPp->bil) ||
  (strpos($st, 'PENGESAHAN HANTAR PP PKPM NEGERI') !== FALSE && $pengguna->bil == $akaunPp->bil);
  }else{
    $bolehEdit = strpos($st, 'JADUAL AKTIVITI') !== FALSE || 
  strpos($st, 'DRAF NEGERI') !== FALSE || 
  strpos($st, 'PENGESAHAN HANTAR NEGERI') !== FALSE || 
...
<?php 
    if(strpos($st, 'DRAF NEGERI') !== FALSE && $pengguna->bil == $program->program_pelapor): ?>
  <div class="card">
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Penghantaran Laporan</div>
      <p>Saya telah membuat semakan dan ingin mengesahkan bahawa program ini dirancang mengikut tarikh, masa dan lokasi yang telah disediakan.</p>
      <button type="button" class="btn btn-outline-primary shadow-sm"  data-bs-toggle="modal" data-bs-target="#hantarRancangPP">
      <i class="bi bi-reply"></i>
        Hantar</button>
    </div>
  </div>

  <div class="modal fade" id="hantarRancangPP" tabindex="-1">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                        ...
                        Tutup</button>
                      <?= form_open('program/sahRancangPPPKPM') ?>
  ...
  <?php if(empty($akaunPp)): ?>
    <div class="alert alert-danger">
      Penting: Sila buat lantikan Penolong Pengarah di link yang disediakan. <br>
      <a href="<?= site_url("ketuaUnit/kemaskini") ?>" class="btn btn-outline-danger shadow-sm">Lantik Penolong Pengarah PKPM</a>
    </div>
  <?php endif; ?>
...
<?php 
    if(strpos($st, 'PENGESAHAN PERANCANGAN PP PKPM NEGERI') !== FALSE && $pengguna->bil == $akaunPp->bil): ?>
  <div class="card">
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Penghantaran Laporan</div>
      <p>Saya telah membuat semakan dan ingin mengesahkan bahawa program ini dirancang mengikut tarikh, masa dan lokasi yang telah disediakan.</p>
      <button type="button" class="btn btn-outline-primary shadow-sm"  data-bs-toggle="modal" data-bs-target="#hantarRancangHq">
      <i class="bi bi-reply"></i>
        Hantar</button>
    </div>
  </div>

  <div class="modal fade" id="hantarRancangHq" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">
  ...
  <?php 
    if(strpos($st, 'PENGESAHAN HANTAR PP PKPM NEGERI') !== FALSE && $pengguna->bil == $akaunPp->bil): ?>
  <div class="card">
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Penghantaran Laporan</div>
      <p>Saya telah membuat semakan dan ingin mengesahkan bahawa program ini telah dilaksanakan mengikut tarikh, masa dan lokasi yang telah disediakan.</p>
      <button type="button" class="btn btn-outline-primary shadow-sm"  data-bs-toggle="modal" data-bs-target="#hantarLaksanaHq">
      <i class="bi bi-reply"></i>
        Hantar</button>
    </div>
  </div>

  <div class="modal fade" id="hantarLaksanaHq" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">
  ...
  <?php 
    if(strpos($st, 'PENGESAHAN HANTAR NEGERI') !== FALSE): ?>
  <div class="card">
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Penghantaran Laporan</div>
      <p>Saya telah membuat semakan dan ingin mengesahkan bahawa program ini telah dilaksanakan mengikut tarikh, masa dan lokasi yang telah disediakan.</p>
      <button type="button" class="btn btn-outline-primary shadow-sm"  data-bs-toggle="modal" data-bs-target="#sahLaksanaPP">
      <i class="bi bi-reply"></i>
        Hantar</button>
    </div>
  </div>

  <div class="modal fade" id="sahLaksanaPP" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">
...
<div class="col-12 col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Pemulangan Semula Laporan</div>
      <p>Saya telah membuat semakan dan ingin mengesahkan bahawa laporan ini belum lengkap. Laporan ini akan bertukar kepada status <b>"JADUAL AKTIVITI"</b>.</p>
      <button type="button" class="btn btn-outline-primary shadow-sm"  data-bs-toggle="modal" data-bs-target="#kuiriLaporan">
      <i class="bi bi-reply"></i>
        Hantar</button>
    </div>
  </div>

  <div class="modal fade" id="kuiriLaporan" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">
                        <i class="bi bi-receipt"></i>
                        Pemulangan Semula Laporan</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <?= form_open('program/pulangSemulaPelapor') ?>
                      <p>Anda pasti untuk membuat pemulangan semula laporan ini?</p>
...
<div class="col-12 col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="card-body">
      ...
      <p>Saya sudah berbincang bersama penyelia pelapor dan pelapor untuk membuat pembatalan penghantaran laporan ini.</p>
...
<?php 
    if(strpos($st, 'PENGESAHAN PERANCANGAN NEGERI') !== FALSE): ?>
  <div class="card">
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Penghantaran Laporan</div>
      <p>Saya telah membuat semakan dan ingin mengesahkan bahawa program ini dirancang mengikut tarikh, masa dan lokasi yang telah disediakan.</p>
      <button type="button" class="btn btn-outline-primary shadow-sm"  data-bs-toggle="modal" data-bs-target="#hantarSahPP">
      <i class="bi bi-reply"></i>
        Hantar</button>
    </div>
  </div>

  <div class="modal fade" id="hantarSahPP" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">
  ...
  <div class="card">
    <div class="card-body">
      <div class="card-title">
        <i class="bi bi-receipt"></i>
        Penghantaran Laporan</div>
      <p>Saya sudah membuat pengemaskinian untuk menghantar laporan ini.</p>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                        <i class="bi bi-x-octagon"></i>
                        Tutup</button>
                      <?= form_open('program/sahLaksanaPPPKPM') ?>
                        <input type="hidden" name="inputProgramBil" value="<?= $program->program_bil ?>">
                        <input type="hidden" name="inputPengguna" value="<?= $pengguna->bil ?>">
                        <button type="submit" class="btn btn-outline-primary shadow-sm">
                        <i class="bi bi-reply"></i>
...
<?php if($pengguna->pengguna_status != ""): ?>
<div class="form-floating mb-3">
  <input type="text" id="inputPelapor" class="form-control" value="<?= strtoupper($program->nama_penuh) ?>" disabled>
  <label for="inputPelapor" class="form-label">Nama Pegawai Pelapor: <span style="color:red;">*</span></label>
</div>
<input type="hidden" name="inputPelapor" value="<?= $program->program_pelapor ?>">
<?php endif; ?>

<?php if($pengguna->pengguna_status == "" || $pengguna->bil == $program->program_pelapor): ?>
...
<div class="form-control mb-3">
  ...
  <?php foreach($senaraiJenis as $jenisProgram): ?>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="inputJenisProgram" id="inputJenisProgram<?= $jenisProgram->jt_bil ?>" value="<?= $jenisProgram->jt_bil ?>" <?php if($program->jt_bil == $jenisProgram->jt_bil){ echo "checked"; } ?> disabled>
    <label class="form-check-label" for="inputJenisProgram<?= $jenisProgram->jt_bil ?>">
      <?= strtoupper($jenisProgram->jt_nama) ?>
    </label>
  </div>
  <?php endforeach; ?>
  <input type="hidden" name="inputJenisProgram" value="<?= $program->jt_bil ?>">
</div>
<?php endif; ?>
                    ...
                    <div class="modal-body">
                      ...
                      <table class="table table-bordered table-sm">
                          ...
                          <?php foreach($senaraiKandungan as $kandungan): ?>
                              ...
                              <?php endforeach; ?>
                              <tr>
                                <th>Tajuk Hebahan / Ceramah Tambahan</th>
                                <th>Tindakan</th>
                              </tr>
                              <tr>
                                <?= form_open('program/tambahKandunganProgram') ?>
