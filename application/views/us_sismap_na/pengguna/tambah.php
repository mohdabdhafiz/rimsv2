...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="font-weight-bold m-0 text-primary">Tambah Akaun Pengguna</h6>
            </div>
            <div class="card-body">
            <?php echo validation_errors(); ?>
            <?php echo form_open('pengguna/proses_tambah'); ?>
                <div class="form-floating mb-3">
                    <input type="text" name="input_nama_penuh" id="input_nama_penuh" class="form-control" placeholder="Nama Penuh" value="<?= set_value('input_nama_penuh'); ?>">
                    <label for="input_nama_penuh" class="form-label">Nama Penuh:</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="input_no_ic" id="input_no_ic" class="form-control" placeholder="Nombor Kad Pengenalan" value="<?= set_value('input_no_ic'); ?>">
                    <label for="input_no_ic" class="form-label">Nombor Kad Pengenalan:</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="input_no_tel" id="input_no_tel" class="form-control" placeholder="Nombor Telefon" value="<?= set_value('input_no_tel'); ?>">
                    <label for="input_no_tel" class="form-label">Nombor Telefon:</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="email" name="input_emel" id="input_emel" class="form-control" placeholder="contoh@contoh.com" value="<?= set_value('input_emel'); ?>">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="input_tempat" id="input_tempat" placeholder="Tempat Bertugas" class="form-control">
                ...
                <button type="submit" class="btn btn-primary shadow-sm w-100">Tambah Akaun Pegawai</button>
            </form>
            </div>
        </div>
