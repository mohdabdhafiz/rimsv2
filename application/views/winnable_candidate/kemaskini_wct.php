<div class="container-fluid">
    ...
    <h3>JANGKAAN CALON PARLIMEN <?php echo strtoupper($parlimen->pt_nama); ?></h3>
    <?php 
    ...
    <div class="row g-3 mt-3">
            ...
            <div class="col-12 col-lg-5">
                <?php echo anchor('winnable_candidate/kemaskini_parlimen/'.$parlimen->pt_bil, 'Kemaskini Maklumat Calon', "class='btn btn-primary w-100'"); ?>
            </div>
        </div>
    </div>
    <?php } ?>
                    ...
                    <option value="Bukan Penyandang" <?php if($calon->wct_status_calon == "Bukan Penyandang"){ echo "selected"; } ?>>Bukan Penyandang</option>
                        ...
                        <td>
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col">
                                    <?php echo anchor('winnable_candidate/verify_padam/'.$calon->wct_bil, 'Padam', "class='btn btn-danger w-100'"); ?>
                                </div>
                                <div class="col">
                                    <?php echo anchor('winnable_candidate/tambahan/'.$calon->wct_bil, 'Kekuatan dan Kelemahan Calon', "class='btn btn-secondary w-100'"); ?>
                                </div>
                            </div>
                        </td>
                    </form>
